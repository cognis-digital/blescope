"""Native cognis-connect emit for blescope — forward findings to any platform.

Maps blescope's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    blescope ... --format json | blescope-emit --to stix
    blescope-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
