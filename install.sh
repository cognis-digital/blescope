#!/usr/bin/env sh
# Universal installer for blescope. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/blescope.git"
echo "Installing blescope ..."
